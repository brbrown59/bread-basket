...
<script type="text/javascript" src="<?php echo $PREFIX; ?>js/modalcontrollers/listing-unclaim-modal.js"></script>
<script type="text/javascript" src="<?php echo $PREFIX; ?>js/modalcontrollers/signin-fail-modal.js"></script>
